...
### Customize Paths<a name="customizing-paths"></a>
...
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `$ZPFX`                  | directory where software with `Makefile` can be pointed to, by e.g. `atclone'./configure --prefix=$ZPFX'` defaults to `~/.local/share/zinit/polaris` |
...
| `ZINIT[LIST_COMMAND]`    | Command to use for displaying a directory tree (i.e, `ls --tree`, `tree`, etc.)                                                                      |
| `ZINIT[MUTE_WARNINGS]`   | If set to `1`, Zinit warnings are muted                                                                                                              |
| `ZINIT[NO_ALIASES]`      | If set to `1`, the aliases `zi` and `zini` are not created                                                                                           |
